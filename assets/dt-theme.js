...
setTimeout(function() {
  if ($("#preloader").length > 0 && $("#preloader").is(":visible")) {
...
function InitCustomFunctions() {
  ...
  $(".custom-product-grid li").click(function () {
    var classNames =
      "list-view-filter grid--2-col-desktop grid--3-col-desktop grid--4-col-desktop grid--5-col-desktop grid--6-col-desktop";
...
if ($(".enquiry-modal").length > 0) {
  var EnquiryModal = document.querySelector(".enquiry-modal");
  var EnquiryTrigger = document.querySelector("#trigger-enquiry");
  var Enquiryclose = document.querySelector(".enquiry-modal .close-button");
...
document
  .querySelector(".header-drawer__close")
  .addEventListener("click", closeDrawerMenu);
